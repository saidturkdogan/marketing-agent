...
public class GmailController {
    ...
    public ResponseEntity<Map<String, Object>> fetchEmails(@PathVariable String companyId,
        ...
        if (!gmailAuthService.isConnected(companyId)) {
            var messages = gmailFetchService.generateMockMessagesInDb(companyId);
            return ResponseEntity.ok(Map.of(
    ...
    public ResponseEntity<?> getMessages(@PathVariable String companyId) {
        if (!gmailAuthService.isConnected(companyId)) {
            return ResponseEntity.ok(gmailFetchService.getMockMessages(companyId));
        }
    ...
    public ResponseEntity<Map<String, String>> draftReply(@RequestBody DraftReplyRequest request) {
